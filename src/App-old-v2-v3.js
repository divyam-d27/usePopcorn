...
export default function App() {
  ...
  // Executes event listener even when the component is not mounted
  ...
  // We can perfectly use the eventHandler onChange for search query instead of useEffect.
    ...
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          // If the network error occured, the code below won't be executed.
          // console.log("=========", res.ok);

          // This code won't be executed, on NO NETWORK
          if (!res.ok)
